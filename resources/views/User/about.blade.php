			...
			<div class="row">
				<div class="col-lg-7">
					<div class="featured-text">
						<h2 class="pb-3">Why <span class="orange-text">RefreshZone</span></h2>
						<div class="row">
							<div class="col-lg-6 col-md-6 mb-4 mb-md-5">
								<div class="list-box d-flex">
									...
									<div class="content">
										<h3>Home Delivery</h3>
										<p>Quench your thirst from the comfort of your home with our refreshing soft drinks delivered straight to your doorstep.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 mb-5 mb-md-5">
								<div class="list-box d-flex">
									...
									<div class="content">
										<h3>Best Price</h3>
										<p>Enjoy the best prices on a wide selection of soft drinks, making every sip even more satisfying..</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 mb-5 mb-md-5">
								<div class="list-box d-flex">
									...
									<div class="content">
										<h3>Custom Box</h3>
										<p>Create your own custom box filled with your favorite soft drinks, tailored to your taste and delivered with convenience.</p>
									</div>
								</div>
							</div>
